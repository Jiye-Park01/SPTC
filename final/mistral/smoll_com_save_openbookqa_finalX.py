...
questions = [item["question_stem"] for item in small_dataset]
...
no_cot_accuracy = embedding_similarity_evaluate(
    ...
    csv_path="/home/jhrew/jiye/SPTC/final/mistral/no_prompt_log_open_finalX.csv"
)
...
few_cot_accuracy = embedding_similarity_evaluate(
    ...
    csv_path="/home/jhrew/jiye/SPTC/final/mistral/zero_shot_cot_log_open_finalX.csv"
)
...
sptc_accuracy = embedding_similarity_evaluate(
    ...
    csv_path="/home/jhrew/jiye/SPTC/final/mistral/sptc_log_open_finalX.csv"
)
